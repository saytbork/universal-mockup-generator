  ...
  render() {
    ...
    return (
      <div className="min-h-screen bg-bg text-gray-900 flex items-center justify-center px-6">
        <div className="w-full max-w-xl rounded-3xl border border-gray-200 dark:border-white/10 bg-white dark:bg-zinc-900 p-8 space-y-4 shadow-md shadow-indigo-500/20">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-indigo-600 px-6 py-3 text-sm font-semibold text-white hover:bg-indigo-700 transition"
          >
            Reload
          </button>
