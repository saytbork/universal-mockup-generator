...
export const metadata: Metadata = {
  title: "Comparisons – BoostUGC vs Other UGC Generators",
  description:
    "Compare BoostUGC with Photoroom, Recraft, ShotDrop, Midjourney and Canva. See why BoostUGC delivers more realistic UGC and product mockups for eCommerce.",
};
      ...
      <div className="max-w-5xl mx-auto px-4 py-20 space-y-12">
        <div className="space-y-3">
          ...
          <p className="text-gray-300">
            Why brands choose BoostUGC for photorealistic UGC.
          </p>
        </div>
