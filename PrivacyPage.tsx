    ...
    <div className="bg-bg text-textPrimary min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-20 space-y-10">
        <div className="space-y-3">
          ...
          <p className="text-textSecondary">How BoostUGC collects, uses, and protects your data.</p>
        </div>

        <div className="space-y-6 text-textSecondary text-sm leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">1. Information we collect</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">2. How we use your data</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">3. Payments</h2>
            <p>Payments are processed by Stripe. We do not store full card details. Stripe may store limited billing information.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">4. AI-generated content</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">5. Data retention</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">6. Security</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">7. Contact</h2>
            <p>For privacy questions or deletion requests, email <a className="text-accent" href="mailto:support@boostugc.app">support@boostugc.app</a>.</p>
          </section>
        </div>
      </div>
    </div>
