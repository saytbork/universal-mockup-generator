...
const pricing: PricingPlan[] = [
  {
    ...
    highlights: [
      ...
      'Watermarked exports',
      'Community support',
      'Zero-risk trial to experience UGC quality.',
    ],
    cta: 'Start Free',
    isFree: true,
  },
  {
    ...
    highlights: [
      '20 credits (was 10) · ~$0.95/credit',
      '2 video generations/month (10 credits each)',
      'No watermark on exports',
      'Standard support',
      'Excellent value for volume; ideal for entrepreneurs.',
    ],
  ...
  },
  {
    ...
    yearlyCaption: 'per year (save 25%)',
    highlights: [
      '60 credits (was 30) · ~$0.82/credit',
      '6 video generations/month (10 credits each)',
      'No watermark on exports',
      'Priority rendering queue · Full feature access',
      'Maximum savings and speed for agencies or constant production.',
    ],
