      ...
      <div className="max-w-5xl mx-auto px-4 py-20 space-y-10">
        ...
        <div className="space-y-6 text-gray-600 text-sm leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-gray-900">1. Your account</h2>
            <p>You must provide accurate information, keep your login secure, and are responsible for activity on your account.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-gray-900">2. Usage</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-gray-900">3. Subscriptions and credits</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-gray-900">4. Refunds</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-gray-900">6. Service changes</h2>
