    ...
    <div className="bg-bg text-textPrimary min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-20 space-y-10">
        <div className="space-y-3">
          ...
          <p className="text-textSecondary">The rules for using BoostUGC.</p>
        </div>

        <div className="space-y-6 text-textSecondary text-sm leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">1. Your account</h2>
            <p>You must provide accurate information, keep your login secure, and are responsible for activity on your account.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">2. Usage</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">3. Subscriptions and credits</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">4. Refunds</h2>
            <p>Refunds are handled case by case. Contact support before disputing charges.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">5. Intellectual property</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">6. Service changes</h2>
            <p>We may update features, models, or pricing. We will notify you of material changes.</p>
          </section>

          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">7. Liability</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-xl font-semibold text-textPrimary">8. Contact</h2>
            <p>Questions? Email <a className="text-accent" href="mailto:support@boostugc.app">support@boostugc.app</a>.</p>
          </section>
        </div>
      </div>
    </div>
