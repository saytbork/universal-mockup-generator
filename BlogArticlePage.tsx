  ...
  return (
    <div className="bg-bg text-textPrimary min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-10">
        <section className="blog-hero rounded-3xl border border-borderSubtle bg-surfaceTint p-8 space-y-4 shadow-md shadow-accent-glow">
          ...
          <figure className="rounded-2xl border border-borderSubtle bg-surface p-4 space-y-2">
        ...
        <section className="blog-body space-y-12">
          ...
          <div className="blog-cta rounded-3xl border border-borderSubtle bg-surfaceTint p-6 space-y-3">
