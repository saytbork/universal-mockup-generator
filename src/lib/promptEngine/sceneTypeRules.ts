...
export const SCENE_TYPE_RULES: Record<SceneType, SceneTypeRules> = {
    studio_packshot: {
        ...
        negativePromptAdditions: [
            'hands', 'visible figures', 'body parts', 'environment', 'natural settings', 'contextual elements',
    ...
    editorial_product: {
        ...
        negativePromptAdditions: ['hands', 'body parts', 'phone camera', 'amateur photography', 'messy scene', 'cluttered']
    },
    lifestyle_product: {
    ...
    ecommerce_blank_space: {
        ...
        imperfectionLevel: 'none',
        realismLevel: 'commercial',
        negativePromptAdditions: ['environment', 'natural context', 'hands', 'body parts', 'complex background', 'shadows on background', 'cluttered']
    },
    bundle_kit: {
        ...
        imperfectionLevel: 'minimal',
        realismLevel: 'editorial',
        negativePromptAdditions: ['hands', 'body parts', 'single product only', 'cluttered arrangement', 'overlapping products']
    }
};
