...
export const PHOTO_MODE_PRESETS: Record<string, string> = {
    ...
    'Foam & Texture': `Editorial macro textures used as controlled design elements: foam bubbles, gel ribbons, creamy swatches, and droplets on the set only. Product stays clean and dry; no pooling; no contact distortion; label stays fully readable. Camera is eye-level or slight frontal and parallel to the surface; no top-down, no overhead, no aerial, no bird’s-eye, no flatlay.`,
