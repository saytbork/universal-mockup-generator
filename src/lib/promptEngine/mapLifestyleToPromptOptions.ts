...
const LIGHTING_SEMANTIC_MAP: Record<string, string> = {
    'Natural Light': 'natural ambient daylight with soft shadows, realistic falloff, and clean window-style illumination across the scene',
    'Sunny Day': 'bright direct sunlight with crisp hard-edged shadows, high contrast, and clean outdoor-style highlights',
    'Golden Hour': 'golden hour sunlight with rich amber warmth, long flattering shadows, and cinematic low-angle glow',
    'Overcast': 'soft diffused cloudy light with low contrast, muted highlights, and even shadow transitions',
    'Cozy Indoors': 'warm ambient indoor lighting from practical sources with gentle falloff, comfortable room tone, and believable household warmth',
    'Ring Light': 'direct frontal ring light with circular catchlights, flatter facial shadows, and creator-style close-range illumination',
