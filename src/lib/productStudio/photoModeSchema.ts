...
export const PHOTO_MODE_SCHEMAS: Partial<Record<PhotoMode, EnvironmentPhotoModeSchema>> = {
    'Hero Landing Page': {
        ...
        subOptions: [
            ...
            { key: 'colors', label: 'Colors', values: ['Brand Colors', 'Custom Color'] },
            { key: 'gradientStyle', label: 'Gradient Style', values: ['Soft', 'Radial', 'Vertical'] },
            { key: 'paletteSource', label: 'Palette Source', values: ['Product label colors', 'Neutral brand tones', 'Custom'] },
        ...
        constraints: [
            'Mandatory negative space reserved for copy placement',
            'No props allowed under any circumstance',
            'Single product focal point only'
        ],
    ...
    'Color Pop Hero': {
        ...
        scope: 'studio',
        description: 'High-impact color-driven hero composition.',
        basePrompt: [
        ...
        subOptions: [
            { key: 'backgroundType', label: 'Background Type', values: ['Solid', 'Gradient'] },
            { key: 'gradientStyle', label: 'Gradient Style', values: ['Soft', 'Radial', 'Vertical'] },
            { key: 'colorSource', label: 'Color Source', values: ['Brand Colors', 'Product Label Colors', 'Custom Color'] },
            { key: 'saturationLevel', label: 'Saturation Level', values: ['Moderate', 'High'] },
            { key: 'contrastStrategy', label: 'Contrast Strategy', values: ['Soft', 'High'] },
            { key: 'negativeSpace', label: 'Negative Space', values: ['Tight', 'Balanced', 'Spacious'] },
        ],
        constraints: [
            'Single product focal point',
            'Color-driven composition only',
            'Clean edges and perfect color fields'
        ],
    ...
    'Ingredient Stack': {
        ...
        scope: 'studio',
        description: 'Exploded vertical component showing formulation energy with controlled floating layers.',
        basePrompt: [
            ...
            'Each layer is visually distinct, aligned with the product below, and grounded through subtle shadows or occlusion.',
            'The product anchors the base of the composition.',
            'Clean studio or soft gradient background with no narrative surface.',
            'Professional studio lighting with soft directional key and minimal contrast.',
            'No flat lay.',
            'No radial or surrounding layouts.',
            'No decorative wellness styling.',
            'No lifestyle or kitchen cues.',
            'No props.',
            'Premium advertising photography with strong visual energy and clarity.'
        ].join(' '),
        subOptions: [],
        constraints: [
            'Exploded vertical stack with central axis alignment',
            'Floating ingredients feel intentional, controlled, and premium',
            'Product anchors the base with weight and stability',
            'Background remains minimal, abstract, or gradient',
            'Allowed ingredients limited to powders, extracts, seeds, roots, capsules, or minimal liquids'
        ],
        requiredPlacement: 'surface',
        allowedInteractions: ['none'],
        allowsPersonPresence: false
