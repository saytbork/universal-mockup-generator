...
export const PHOTO_MODE_SCHEMAS: Partial<Record<PhotoMode, EnvironmentPhotoModeSchema>> = {
    ...
    'Celebration Chill': {
        ...
        scope: 'environment',
        description: 'Editorial chilled wine service scene with bucket, glasses, and restrained hospitality action.',
        basePrompt: 'editorial chilled wine service scene with glasses, cold hospitality cues, restrained action context, believable premium atmosphere, tactile condensation, real service materials, no synthetic fx polish',
        subOptions: [
