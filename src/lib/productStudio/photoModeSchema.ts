...
export const PHOTO_MODE_SCHEMAS: Partial<Record<PhotoMode, EnvironmentPhotoModeSchema>> = {
    ...
    'Ingredient Stack': {
        ...
        scope: 'studio',
        description: 'Formulation-focused advertising composition with structured ingredient hierarchy.',
        basePrompt: [
            ...
            'Neutral studio environment with non-narrative support surface.',
            'Clean professional lighting optimized for ingredient legibility.',
            'No decorative intent.',
            'No real-world usage context.',
            'No editorial wellness styling.',
            'No flat lay.',
            'No props of any kind.',
            'Single product with functional formulation ingredients only.',
            'Shot by a professional creative team.',
            'High-end, informative advertising quality.'
        ].join(' '),
        subOptions: [],
        constraints: [
            'Ingredient hierarchy must be visually readable',
            'Vertical or stepped stack only',
            'No flat lay',
            'No surround or radial layout',
            'No decorative ingredients',
