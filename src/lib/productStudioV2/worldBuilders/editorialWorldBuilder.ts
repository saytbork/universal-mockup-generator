...
const PHOTO_MODE_SCENE_STYLE_MAP: Record<string, string> = {
  ...
  'Routine Carousel': 'SCENE_STYLE: clean studio multi-product arrangement with editorial spacing, routine lifestyle context, product-first hierarchy',
  ...
  'Macro Dew Label': 'SCENE_STYLE: true macro close-up of the product label and bottle material texture, label occupying most of frame, realistic dew droplets with optical magnification behavior, ultra-sharp commercial detail and controlled highlights',
