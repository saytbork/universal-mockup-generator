...
export function buildArtworkImmutability(): string {
  return [
    ...
    'Treat printed artwork as locked photographic content, not generative text.',
    'Do not reinterpret typography.',
    'Do not regenerate characters.',
    'Do not invent, replace, omit, transpose, or complete letters, numbers, symbols, or punctuation.',
