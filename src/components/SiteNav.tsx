  ...
  const allLinks = (
    <>
      ...
      <div className="relative">
        ...
        {showResources && (
          <div className="absolute right-0 mt-2 bg-white text-gray-900 shadow-md shadow-indigo-500/20 rounded-2xl border border-gray-200 p-4 flex-col gap-2 min-w-[180px]">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {isAuthed ? (
            <>
              <Link
                to="/dashboard"
                className="rounded-full bg-indigo-600 px-4 py-2 font-semibold text-white hover:bg-indigo-700 transition"
              >
                Dashboard
              </Link>
              <Link
            ...
            <div className="flex flex-col gap-3">
              {isAuthed ? (
                <>
                  <Link
                    to="/dashboard"
                    className="rounded-full bg-indigo-600 px-4 py-2 font-semibold text-white text-center hover:bg-indigo-700 transition"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Dashboard
                  </Link>
