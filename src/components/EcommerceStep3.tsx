      ...
      <section className="rounded-xl border border-gray-200 bg-whiteTint p-4 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-whiteTint px-3 py-2 text-xs text-gray-900 hover:bg-whiteTint disabled:opacity-40"
          >
            <ImageIcon size={14} />
