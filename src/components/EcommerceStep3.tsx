  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-white/10 bg-gray-900/40 p-4 space-y-4">
        <p className="text-xs uppercase tracking-[0.35em] text-gray-400">Generation Overrides</p>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-xs text-gray-400">Blank space:</span>
          ...
          {requiredDir && (
            <span className="text-xs text-gray-400">
              (template suggests: <span className="text-gray-200">{requiredDir}</span>)
            </span>
          )}
        </div>
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-xs text-gray-400">View framing:</span>
          {(
            [
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <p className="text-xs uppercase tracking-[0.35em] text-gray-400">Items</p>
          <button
            type="button"
            onClick={() =>
              onChange({
...
function StepsEditor({ block, onChange }: { block: StepsBlock; onChange: (next: StepsBlock) => void }) {
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <p className="text-xs uppercase tracking-[0.35em] text-gray-400">Steps</p>
          <button
            type="button"
            onClick={() =>
              onChange({
...
function TestimonialsEditor({ block, onChange }: { block: TestimonialBlock; onChange: (next: TestimonialBlock) => void }) {
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <p className="text-xs uppercase tracking-[0.35em] text-gray-400">Cards</p>
          <button
            type="button"
  ...
  return (
    <label className="space-y-1 block">
      ...
      <input
        ...
        className="w-full rounded-lg border border-white/10 bg-black/30 px-3 py-2 text-sm text-white focus:border-indigo-400 focus:outline-none"
      />
    </label>
  );
}
