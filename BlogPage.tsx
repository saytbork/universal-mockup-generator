        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {posts.map(post => (
            ...
            >
              ...
              <Link
                to={`/blog/${post.slug}`}
                className="inline-flex items-center justify-center bg-surface text-textPrimary px-4 py-2 rounded-2xl border border-borderSubtle hover:bg-surfaceTint text-sm transition-colors"
              >
                Read Article
              </Link>
            </div>
