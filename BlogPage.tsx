        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {posts.map(post => (
            ...
            >
              ...
              <Link
                to={`/blog/${post.slug}`}
                className="inline-flex items-center justify-center bg-white text-gray-900 px-4 py-2 rounded-2xl border border-gray-200 hover:bg-gray-100 text-sm transition-colors"
              >
                Read Article
              </Link>
            </div>
