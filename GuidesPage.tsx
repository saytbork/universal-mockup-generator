        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {guides.map(guide => (
            ...
            >
              ...
              <a
                href="#"
                className="inline-block bg-surface text-textPrimary px-4 py-2 rounded-2xl border border-borderSubtle hover:bg-surfaceTint text-sm mt-4 transition-colors"
              >
                Read Guide
              </a>
            </div>
