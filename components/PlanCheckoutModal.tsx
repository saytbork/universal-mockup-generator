    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-whiteTint px-4">
      <div className="w-full max-w-lg rounded-2xl bg-whiteGlass border border-gray-200 shadow-md shadow-md shadow-indigo-500/20 p-8 space-y-6 relative">
        ...
        <button
          disabled={isDisabled}
          onClick={onConfirm}
          className="w-full rounded-full bg-indigo-600 text-white py-3 font-semibold text-white shadow-md shadow-md shadow-indigo-500/20 hover:bg-indigo-600 text-white disabled:bg-whiteTint disabled:cursor-not-allowed"
        >
