  ...
  return (
    <div className={`relative bg-surfaceTint p-6 rounded-lg shadow-lg border border-borderSubtle flex flex-col gap-4 h-full ${disabled ? 'opacity-60' : ''}`}>
      ...
      >
        ...
        <span className="text-sm font-semibold text-textPrimary">Click or drag model photo</span>
      ...
      <div className="flex flex-col gap-2">
        <label className="text-xs uppercase tracking-widest text-textMuted">Interaction notes (optional)</label>
        <textarea
          value={cleanedNotes}
