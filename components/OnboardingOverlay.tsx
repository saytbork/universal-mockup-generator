...
const OnboardingOverlay: React.FC<OnboardingOverlayProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      />
      <div
        className="absolute glass-card rounded-3xl border border-gray-200 p-5 text-left w-80 pointer-events-auto shadow-md shadow-indigo-500/20 animate-fade-up"
        style={{
          top: cardTop,
          left: cardLeft,
        }}
      >
        ...
        <div className="mt-4 flex items-center justify-between text-xs">
          ...
          <button
            onClick={onNext}
            className="rounded-full bg-indigo-600 px-4 py-1.5 text-white font-semibold hover:bg-indigo-700 transition"
          >
