    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className={`relative h-6 w-11 rounded-full transition ${enabled ? 'bg-indigo-600' : 'bg-gray-50'
              ...
              {normalizedHeroPersonaPresets.map(preset => {
                ...
                return (
                  <button
                    ...
                    className={`rounded-xl border px-3 py-2 text-left transition ${isActive ? 'bg-indigo-600 text-white border-indigo-600 shadow-md shadow-indigo-500/20 scale-105 duration-500' : 'border-gray-200 bg-gray-100 text-gray-900 hover:border-indigo-600'
                      }`}
                  >
